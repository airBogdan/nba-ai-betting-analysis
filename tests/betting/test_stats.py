"""Tests for betting.stats module."""
...
from betting.stats.stats import generate_dashboard
from betting.stats.compute import (
    _pick_side,
...
class TestGenerateDashboard:
    def test_generates_html_file(self, tmp_path):
        ...
        with (
            patch("betting.stats.stats.get_history", return_value=history),
            patch("betting.stats.stats.get_skips", return_value=[]),
            patch("betting.stats.stats.webbrowser"),
        ):
    ...
    def test_empty_history_prints_message(self, capsys):
        ...
        with (
            patch("betting.stats.stats.get_history", return_value=empty),
            patch("betting.stats.stats.get_skips", return_value=[]),
        ):
            generate_dashboard()
    ...
    def test_with_skips(self, tmp_path):
        ...
        with (
            patch("betting.stats.stats.get_history", return_value=history),
            patch("betting.stats.stats.get_skips", return_value=skips),
            patch("betting.stats.stats.webbrowser"),
        ):
            generate_dashboard(str(output))
...
class TestGenerateDashboardPaper:
    def test_with_paper_trades(self, tmp_path):
        ...
        with (
            patch("betting.stats.stats.get_history", return_value=history),
            patch("betting.stats.stats.get_skips", return_value=[]),
            patch("betting.stats.stats.get_paper_history", return_value=paper_history),
            patch("betting.stats.stats.webbrowser"),
        ):
            generate_dashboard(str(output))
