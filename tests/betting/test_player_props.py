...
from execution.gamma import extract_player_props, find_prop_market
from execution.matching import prop_pick_to_outcome
from betting.polymarket_prices import extract_poly_price_for_prop
from betting.evaluation import _find_player_stat, _evaluate_prop_bet
from betting.analyze.gamedata import load_props_for_date
from betting.io import get_voids, VOIDS_PATH
...
class TestLoadPropsForDate:
    def test_loads_props_files(self, tmp_path):
        ...
        with patch("betting.analyze.gamedata.OUTPUT_DIR", output_dir):
...
class TestDNPVoidFlow:
    ...
    def test_dnp_voids_bet_and_removes_from_active(self, tmp_path):
        ...
        from betting.evaluation import _find_player_stat, _evaluate_prop_bet
        from betting.io import save_void, get_voids, get_active_bets, save_active_bets
        ...
        with patch("betting.io.VOIDS_PATH", voids_path):
