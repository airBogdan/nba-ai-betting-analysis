...
class TestMatchupPipelineIntegration:
    ...
    def matchup_input(self):
        ...
        from sports.nba.h2h_stats import compute_h2h_summary
        with patch("sports.nba.h2h_stats.get_current_nba_season_year", return_value=2025):
    ...
    def _run_with_mocks(self, matchup_input):
        ...
        from sports.nba.matchup import build_matchup_analysis
        with patch("sports.nba.matchup.core.get_current_nba_season_year", return_value=2025), \
             patch("sports.nba.matchup.h2h.get_current_nba_season_year", return_value=2025), \
             patch("sports.nba.h2h_stats.get_current_nba_season_year", return_value=2025):
