...
from sports.nba.games import (
    process_game_stats,
    process_h2h_results,
)
from sports.nba.h2h_stats import (
    compute_h2h_summary,
...
class TestProcessH2hResults:
    ...
    @patch("sports.nba.games.get_current_nba_season_year")
...
class TestWeightedH2hGames:
    ...
    @patch("sports.nba.h2h_stats.get_current_nba_season_year", return_value=None)
