"""NBA Analytics pipeline — matchup analysis and output generation."""
...
from .teams import get_teams_standings
from .games import h2h, add_game_statistics_to_h2h_results
from .h2h_stats import compute_h2h_summary
from .matchup import build_matchup_analysis
